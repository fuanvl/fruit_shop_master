...
public class LoginController extends BaseController {
    ...
    public String toFindPass(User u,Model model,HttpServletRequest request){
        if (userService.getById(u.getId())!=null){
            User obj = userService.load(u.getId());
